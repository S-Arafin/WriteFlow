import { ArrowRight, Calendar, Clock, BookOpen, Plus } from 'lucide-react';
...
* **On-Premise Relays**: Critical workloads can be routed to isolated on-premise models, bypassing external public APIs.`,
      ...
      },
      {
        ...
        readTime: '6 min read',
        title: 'Prompt Engineering vs. Systematic Workspaces: The New Writing Paradigm',
        excerpt:
    ...
    <div className="bg-background text-foreground min-h-screen py-16 transition-colors duration-300">
      ...
      <div className="container mx-auto max-w-4xl px-4 text-center space-y-6">
        ...
        <p className="mx-auto max-w-2xl text-base leading-relaxed text-neutral-600 dark:text-neutral-400 sm:text-lg">
          Deep-dives into prompt engineering workflows, enterprise data governance, custom LLM fine-tuning schemas, and structural copywriting discipline.
        </p>
        ...
        {session && (
          <div className="pt-4 flex justify-center">
            <Link
              href="/blog/create"
              id="create-blog-btn"
              className="inline-flex items-center gap-2 rounded-xl bg-indigo-600 px-5 py-3 text-sm font-semibold text-white shadow-lg shadow-indigo-600/20 hover:bg-indigo-500 dark:bg-indigo-500 dark:hover:bg-indigo-400 transition-all hover:scale-105 active:scale-95"
            >
              ...
              >
                ...
                <div className="relative z-10 space-y-6">
                  ...
                  <div className="flex items-center justify-between font-mono text-xs text-neutral-500 dark:text-neutral-400">
                    <span className="rounded-full border border-indigo-500/20 bg-indigo-500/10 px-2.5 py-1 text-[10px] font-semibold tracking-wider text-indigo-600 dark:text-indigo-400 uppercase">
                      {post.category}
                    </span>
                  ...
                  <div className="space-y-3">
                    <h2 className="text-xl font-bold tracking-tight text-neutral-900 dark:text-white transition-colors duration-200 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 sm:text-2xl">
                      {post.title}
                    </h2>
                ...
                {/* Author & CTA */}
                <div className="relative z-10 mt-8 flex items-center justify-between border-t border-neutral-200 dark:border-neutral-800/80 pt-6">
                  ...
                  <Link
                    href={`/blog/${post.slug}`}
                    className="flex items-center space-x-1.5 text-xs font-semibold text-indigo-600 dark:text-indigo-400 transition-colors hover:text-indigo-500 dark:hover:text-indigo-300"
                  >
      ...
      <div className="container mx-auto max-w-4xl px-4 pt-16">
        <div className="relative space-y-6 overflow-hidden rounded-2xl border border-neutral-200 bg-white/50 dark:border-neutral-800 dark:bg-neutral-900/30 p-8 text-center sm:p-12 shadow-sm backdrop-blur-md">
          ...
          <div className="relative z-10 mx-auto max-w-md space-y-4">
            ...
            <p className="text-sm text-neutral-600 dark:text-neutral-400">
              Receive advanced workspace patterns, prompt structure designs, and our product roadmap releases directly in your inbox.
            </p>
            <div className="pt-2">
              <Link
                href="/#newsletter"
                className="inline-flex cursor-pointer items-center space-x-2 rounded-xl bg-indigo-600 px-6 py-3 text-xs font-semibold text-white shadow-md shadow-indigo-600/10 hover:bg-indigo-500 transition-all hover:scale-105 active:scale-95"
              >
